...
public:
  ...
  sort_insert_iterator & operator++(){return *this;}
  sort_insert_iterator operator++(int){return *this;}
  sort_insert_iterator & operator=(typename Container::value_type const & value)
  {
    container.insert(lower_bound(begin(container), end(container), value), value);
    return *this;
  }
  sort_insert_iterator & operator*(){return *this;}
...
template <class Container>
sort_insert_iterator<Container> sort_inserter (Container & cont)
{
  return cont;//sort_insert_iterator(cont);
}
